  ...
  methods: {
    animate: async function animate () {
      if (this.videoPlaying) {
        ...
        var image = browser.fromPixels(this.$refs.video);
        switch (this.state) {
          case 'training':
...
var __vue_staticRenderFns__ = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"camera-gestures-lds-ring"},[_c('div'),_vm._v(" "),_c('div'),_vm._v(" "),_c('div'),_vm._v(" "),_c('div')])}];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-db1bb9ec_0", { source: ".camera-gestures-container[data-v-db1bb9ec]{width:227px}video.camera-gestures-camera-feed[data-v-db1bb9ec]{transform:rotateY(180deg);-webkit-transform:rotateY(180deg);-moz-transform:rotateY(180deg);width:227px;max-width:100%}.camera-gestures-progress-bar[data-v-db1bb9ec]{height:5px;background:#41b883;border-radius:5px 0 0 5px}.camera-gestures-progress-bar.invisible[data-v-db1bb9ec]{background:0 0}.camera-gestures-instructions[data-v-db1bb9ec]{text-align:center}.camera-gestures-loader-container[data-v-db1bb9ec]{width:227px;height:100px}.camera-gestures-lds-ring[data-v-db1bb9ec]{display:block;position:relative;left:calc(50% - 32px);top:calc(50% - 32px);width:64px;height:64px}.camera-gestures-lds-ring div[data-v-db1bb9ec]{box-sizing:border-box;display:block;position:absolute;width:51px;height:51px;margin:6px;border:6px solid #41b883;border-radius:50%;animation:camera-gestures-lds-ring-data-v-db1bb9ec 1.2s cubic-bezier(.5,0,.5,1) infinite;border-color:#41b883 transparent transparent transparent}.camera-gestures-lds-ring div[data-v-db1bb9ec]:nth-child(1){animation-delay:-.45s}.camera-gestures-lds-ring div[data-v-db1bb9ec]:nth-child(2){animation-delay:-.3s}.camera-gestures-lds-ring div[data-v-db1bb9ec]:nth-child(3){animation-delay:-.15s}@keyframes camera-gestures-lds-ring-data-v-db1bb9ec{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-db1bb9ec";
  /* module identifier */
